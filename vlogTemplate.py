vlogTemplate = """/*
    ...
    $website
    ===================================
    Source File:    $dot_filename
    Output File:    $filename
    Generated on:   $creation_date

$digraph
    To reproduce a graphical version of the the state diagram from the text
    above, go to the Graphviz website and download their free tool.
